...
METADATA_FIELDS = [
    ...
    "Wind (knots) 0 if none", "Recent weather", 
    "State of Tide", "Flow", "Recent events (human)", "Total weight (lb)",
...
DROPDOWN_OPTIONS = {
    ...
    "State of Tide": ["High", "Low", "Mid", "Other", "N/A"],
    "Flow": ["Ebbing", "Flooding", "Slack", "Other", "N/A"],
    "Recent events (human)": ["Festival", "Holiday", "Concert", "Busy Weekend", "Summer Camp", "None", "Other"],
    "Times": [
