...
# Metadata tracking fields. "Submission Timestamp" is automated and hidden from manual inputs.
METADATA_FIELDS = [
    "Date", "Submission Timestamp", "Location", "Name of Organization/Individual", "Email", "City", "State", "Country",
    "Type of cleanup", "Type of location (i.e. Sandy Beach, Marina, Open Water)", 
...
DEBRIS_GROUPS = {
    ...
    "Foam": [
        ...
        "Blue Construction Foam", "Construction Foam w Foil", "Foam Meat Trays",
        "MICRO foam <5mm", "SMALL foam 5-30mm", "LARGE foam >30mm"
    ],
    "Miscellaneous": [
...
SUMMARY_TOTALS = [
    "Total Plastic Items (excluding Foam)", "Total Foam Items", "Total PPE Items", "Total Metal Items", 
    "Total Glass/Rubber Items", "Total Paper/Cloth Items", "Total Fishing Debris Items", 
    "Total Plastic Fragments (> 30mm)", "Total Plastic Fragments (5-30mm)", "Total Microplastics (0-5mm)", 
    "Total Misc", "Total (All)", "Outlier"
]
